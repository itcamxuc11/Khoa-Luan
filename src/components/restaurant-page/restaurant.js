...
export default class Restaurant extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { restaurantName: '', restaurantAdress: '', typeFoods: [], itemList: [] };
    }
                        ...
                        <div className="content">
                            <nav className="restaurant__menu">
                                <ul className="restaurant__menu-items menu">
                                    {
                                        this.state.typeFoods.map((value, key) => {
                                            return (
                                    ...
                                    this.state.typeFoods.map((value, key) => {
                                        return (
                                            ...
                                            <div className="container">
                                                {
                                                    this.state.itemList.filter(item => item.data.type === value).map((val, index) => {
                                                        return (
